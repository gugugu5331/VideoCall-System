...
# Install wget and python for ONNX Runtime
RUN apt-get install -y wget python3 python3-pip

# Install ONNX Runtime
COPY install/onnxruntime /tmp/install/onnxruntime
RUN chmod +x /tmp/install/onnxruntime/install_onnxruntime.sh && \
    /tmp/install/onnxruntime/install_onnxruntime.sh
